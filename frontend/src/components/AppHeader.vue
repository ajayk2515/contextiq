...
<template>
  <header class="border-b border-line bg-white">
    ...
    >
      ...
      <nav
        aria-label="Primary"
        class="order-3 flex h-11 w-full items-end gap-4 overflow-x-auto sm:order-2 sm:h-16 sm:w-auto lg:gap-6"
      >
        ...
        <RouterLink class="nav-link" :to="{ name: 'inspector' }">Inspector</RouterLink>
        <RouterLink class="nav-link" :to="{ name: 'evaluations' }">Evaluate</RouterLink>
        <RouterLink class="nav-link" :to="{ name: 'analytics' }">Analytics</RouterLink>
      </nav>
